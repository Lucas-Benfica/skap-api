...
import { getCarByCategory, getCarById, getCarList, getCarRanking, postCreateCar } from "../controllers/carsController.js";
...
carsRouter.get('/cars/category/:cartegory', getCarByCategory);
